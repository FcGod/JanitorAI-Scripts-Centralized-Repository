...
(function(root){
  ...
  function notify(){ for (var i=0;i<_subs.length;i++){ try{ _subs[i](_library); }catch(_e){} } }
  function onReady(fn){ if (typeof fn === 'function'){ _subs.push(fn); if (_ready) fn(_library); } }
          ...
          if (xhr.status >= 200 && xhr.status < 300){
            try {
              ...
              if (data && data.physical && data.mental && data.emotional){
                _library = data; _ready = true; notify();
              }
